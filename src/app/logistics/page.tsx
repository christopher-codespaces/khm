    ...
    <>
      ...
      <main className="min-h-screen bg-[#0B0F14] text-white">
        {(() => {
          ...
          const modes = ["STANDARD", "ACCELERATED", "CONTINGENCY"] as const;
          ...
          const contentByMode: Record<
            Mode,
            {
              ...
              loadValue: string;
              partnerNote: string;
              riskPill: { text: string; tone: "moderate" | "elevated" };
              riskText: string;
              cta: string;
            }
          > = {
            STANDARD: {
              ...
              riskText:
                "Weather forecast near Port Hedland may affect berthing schedules within 48h.",
          ...
          function RiskBadge({
            ...
            tone: "moderate" | "elevated";
            text: string;
          }) {
            const cls =
              tone === "elevated"
                ? "bg-red-500 text-white"
                : "bg-red-500/90 text-white"; // screenshot uses red for MODERATE; keep consistent
            return (
              <span
                className={`rounded-lg px-3 py-1 text-xs font-semibold ${cls}`}>
                {text}
              </span>
            );
          }
          ...
          return (
            <>
              {/* SEO / TAB HEADERS (place in your app router page/layout) */}
              {/*
          export const metadata = {
            title: "KHM Minerals | Logistics & Export",
            description:
              "Logistics control status across transit, port handling, and risk monitoring for export coordination.",
          };
        */}
