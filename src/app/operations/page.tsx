                  ...
                  <Panel className="mt-6">
                    ...
                    <div className="px-5 py-6">
                      ...
                      <p className="mt-4 text-sm leading-relaxed text-white/70">
                        Infrastructure status is currently optimal. Primary pit
                        depth reaching Layer 4 stabilization zones.
                      </p>
                ...
                <MotionBlock delay={0.15}>
                  <Panel className="mt-6">
                    ...
                    <div className="px-5 py-6">
                      ...
                      <p className="mt-4 text-sm leading-relaxed text-white/70">
                        Spectrometric analysis in progress. Lab environment
                        stabilized for high-precision grading.
                      </p>
